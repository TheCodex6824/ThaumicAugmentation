...
public interface IWardStorageServer extends IWardStorage {
     ...
     * @param owner The UUID of the new owner
     */
    void setWard(BlockPos pos, UUID owner, World syncTo);
     ...
     * @param pos The position of the block to clear
     */
    void clearWard(BlockPos pos, World syncTo);
     ...
     */
    void clearAllWards(World syncTo, BlockPos inside);
     ...
     */
    @Nullable NBTTagCompound fullSyncToClient(Chunk chunk, UUID player);
     ...
     * @return An NBTTagCompound to send to the client for sync purposes, or null if no sync is needed
     */
    @Nullable NBTTagCompound fullSyncToClient(Chunk chunk, UUID player, boolean force);
