...
public final class TAItems {
    ...
    public static final Item IMPULSE_CANNON_AUGMENT2 = null;
    ...
    public static Item[] getAllItems() {
        return new Item[] {GAUNTLET, MATERIAL, SEAL_COPIER, ARCANE_DOOR, KEY, VOID_BOOTS, RIFT_SEED, AUGMENT_CASTER_RIFT_ENERGY_STORAGE,
                ...
                ELYTRA_HARNESS, ELYTRA_HARNESS_AUGMENT, AUTOCASTER_PLACER, IMPULSE_CANNON, IMPULSE_CANNON_AUGMENT, IMPULSE_CANNON_AUGMENT2,
