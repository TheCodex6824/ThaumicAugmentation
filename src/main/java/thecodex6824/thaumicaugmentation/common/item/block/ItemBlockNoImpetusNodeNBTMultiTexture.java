...
public class ItemBlockNoImpetusNodeNBTMultiTexture extends ItemMultiTexture {

    public ItemBlockNoImpetusNodeNBTMultiTexture(Block block, String[] namesByMapper) {
        super(block, null, namesByMapper);
    }
