...
public class ItemVoidBoots extends ItemArmor implements IDyeableItem, IModelProvider, IArmorReduceFallDamage, IRechargable,
	...
	public ItemVoidBoots(String name) {
		super(TAMaterials.VOID_BOOTS, 0, EntityEquipmentSlot.FEET);
		ItemTABase.sharedInit(this, name);
	}
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack stack) {
		if (!world.isRemote && player.ticksExisted % 20 == 0) {
			...
			boolean apply = !player.capabilities.isFlying && RechargeHelper.getCharge(stack) > 0;
