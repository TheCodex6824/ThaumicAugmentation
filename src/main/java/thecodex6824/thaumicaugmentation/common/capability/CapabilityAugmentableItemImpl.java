...
public final class CapabilityAugmentableItemImpl {

    private CapabilityAugmentableItemImpl() {}
    
    public static void init() {
        CapabilityManager.INSTANCE.register(IAugmentableItem.class, new Capability.IStorage<IAugmentableItem>() {
    ...
    public static class DefaultImpl implements IAugmentableItem {
        ...
        public DefaultImpl(ItemStack[] augs) {
