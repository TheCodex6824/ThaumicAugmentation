...
public class TransformerGolemUpdateAttributes extends Transformer {

    private static final String CLASS = "thaumcraft.common.golems.EntityThaumcraftGolem";
    ...
    public boolean transform(ClassNode classNode, String name, String transformedName) {
        try {
            MethodNode set = TransformUtil.findMethod(classNode, "updateEntityAttributes", "()V");
            int ret = 0;
