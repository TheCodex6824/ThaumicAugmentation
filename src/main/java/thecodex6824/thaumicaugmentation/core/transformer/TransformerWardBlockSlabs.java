...
public class TransformerWardBlockSlabs extends Transformer {
    ...
    public boolean transform(ClassNode classNode, String transformedName) {
        try {
            ...
            int ret = TransformUtil.findFirstInstanceOfMethodCall(use, 0,
                    TransformUtil.remapMethodName("net/minecraft/entity/player/EntityPlayer", "func_175151_a",
                            Type.BOOLEAN_TYPE, Type.getType("Lnet/minecraft/util/math/BlockPos;"),
                            Type.getType("Lnet/minecraft/util/EnumFacing;"),
                            Type.getType("Lnet/minecraft/item/ItemStack;")),
                    "(Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/util/EnumFacing;Lnet/minecraft/item/ItemStack;)Z",
            ...
            if (ret != -1 && use.instructions.get(ret).getNext() instanceof JumpInsnNode) {
                ...
                use.instructions.insert(insertAfter, new MethodInsnNode(Opcodes.INVOKESTATIC,
                        TransformUtil.HOOKS_COMMON, "checkWardSlab",
