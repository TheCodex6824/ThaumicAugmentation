        ...
        try {
            ...
            int afterRegularTileRender = TransformUtil.findFirstInstanceOfMethodCall(render, offset,
                    TransformUtil.remapMethodName(
                            "net/minecraft/client/renderer/tileentity/TileEntityRendererDispatcher", "func_147549_a",
                            Type.VOID_TYPE, Type.getType("Lnet/minecraft/tileentity/TileEntity;"), Type.DOUBLE_TYPE,
                            Type.DOUBLE_TYPE, Type.DOUBLE_TYPE, Type.FLOAT_TYPE),
            ...
            if (offset != -1 && nextLabel != -1 && afterRenderJump != -1 && afterRegularTileRender != -1) {
                ...
                render.instructions.insert(afterRender, new MethodInsnNode(Opcodes.INVOKEVIRTUAL,
                        ...
                        TransformUtil.remapMethodName("net/minecraft/client/renderer/texture/TextureManager",
                                "func_110577_a", Type.VOID_TYPE, Type.getType("Lnet/minecraft/util/ResourceLocation;")),
                        "(Lnet/minecraft/util/ResourceLocation;)V", false));
                render.instructions.insert(afterRender, new FieldInsnNode(Opcodes.GETSTATIC,
                        "net/minecraft/client/renderer/texture/TextureMap", TransformUtil
                                .remapFieldName("net/minecraft/client/renderer/texture/TextureMap", "field_110575_b"),
                        "Lnet/minecraft/util/ResourceLocation;"));
                render.instructions.insert(afterRender,
                        new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/client/Minecraft",
                                TransformUtil.remapMethodName("net/minecraft/client/Minecraft", "func_110434_K",
                                        Type.getType("Lnet/minecraft/client/renderer/texture/TextureManager;")),
                                "()Lnet/minecraft/client/renderer/texture/TextureManager;", false));
                render.instructions.insert(afterRender,
                        new FieldInsnNode(Opcodes.GETFIELD, "thaumcraft/client/gui/GuiResearchPage",
                ...
                render.instructions.insert(insertAfter, new MethodInsnNode(Opcodes.INVOKESTATIC,
                        TransformUtil.HOOKS_CLIENT, "renderFastTESRBlueprint",
                ...
                render.instructions.insert(insertAfter, new MethodInsnNode(Opcodes.INVOKEVIRTUAL,
                        "net/minecraft/tileentity/TileEntity", "hasFastRenderer", "()Z", false));
                render.instructions.insert(insertAfter, new VarInsnNode(Opcodes.ALOAD, 22));
            }
            else
