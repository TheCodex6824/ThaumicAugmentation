...
public class TransformerTouchTrajectoryEntitySelection extends Transformer {
    ...
    public boolean transform(ClassNode classNode, String transformedName) {
        try {
            MethodNode exe = TransformUtil.findMethod(classNode, "supplyTrajectories",
                    "()[Lthaumcraft/api/casters/Trajectory;");
            ...
            if (ret != -1) {
                ...
                exe.instructions.insert(insertAfter, new MethodInsnNode(Opcodes.INVOKESTATIC,
                        TransformUtil.HOOKS_COMMON, "fireTrajectoryGetEntityEvent",
