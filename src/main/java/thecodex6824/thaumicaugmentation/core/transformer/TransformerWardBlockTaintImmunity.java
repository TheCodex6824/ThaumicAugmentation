...
public class TransformerWardBlockTaintImmunity extends Transformer {
    ...
    public boolean transform(ClassNode classNode, String transformedName) {
        try {
            MethodNode spread = TransformUtil.findMethod(classNode, "spreadFibres",
                    "(Lnet/minecraft/world/World;Lnet/minecraft/util/math/BlockPos;Z)V");
            int offset = TransformUtil.findFirstInstanceOfMethodCall(spread, 0,
                    TransformUtil.remapMethodName("net/minecraft/block/Block", "func_176195_g", Type.FLOAT_TYPE,
                            Type.getType("Lnet/minecraft/block/state/IBlockState;"),
                            Type.getType("Lnet/minecraft/world/World;"),
                            Type.getType("Lnet/minecraft/util/math/BlockPos;")),
                    "(Lnet/minecraft/block/state/IBlockState;Lnet/minecraft/world/World;Lnet/minecraft/util/math/BlockPos;)F",
            ...
            if (offset != -1) {
                ...
                spread.instructions.insert(insertAfter,
                        new MethodInsnNode(Opcodes.INVOKEINTERFACE, "net/minecraft/block/state/IBlockProperties",
                                TransformUtil.remapMethodName("net/minecraft/block/state/IBlockProperties",
                                        "func_185887_b", Type.FLOAT_TYPE, Type.getType("Lnet/minecraft/world/World;"),
                                        Type.getType("Lnet/minecraft/util/math/BlockPos;")),
                                "(Lnet/minecraft/world/World;Lnet/minecraft/util/math/BlockPos;)F", true));
