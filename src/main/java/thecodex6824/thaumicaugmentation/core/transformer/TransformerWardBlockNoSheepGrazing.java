...
public class TransformerWardBlockNoSheepGrazing extends Transformer {
    ...
    public boolean transform(ClassNode classNode, String transformedName) {
        try {
            MethodNode nom = TransformUtil.findMethod(classNode, TransformUtil.remapMethodName(
                    "net/minecraft/entity/ai/EntityAIEatGrass", "func_75250_a", Type.BOOLEAN_TYPE), "()Z");
            ...
            if (tallGrass != -1 && normalGrass != -1) {
                ...
                if (insertAfter.getPrevious() instanceof MethodInsnNode
                        && grassAfter.getPrevious() instanceof FieldInsnNode) {
                    ...
                    if (insertPrev.name.equals("apply") && insertPrev.owner.equals("com/google/common/base/Predicate")
                            && insertPrev.itf
                            && grassPrev.name
                                    .equals(TransformUtil.remapFieldName("net/minecraft/init/Blocks", "field_150349_c"))
                            && grassPrev.owner.equals("net/minecraft/init/Blocks")
                            && grassPrev.desc.equals("Lnet/minecraft/block/BlockGrass;")) {

                        nom.instructions.insert(insertAfter,
                        ...
                        nom.instructions.insert(insertAfter, new FieldInsnNode(Opcodes.GETFIELD,
                                "net/minecraft/entity/ai/EntityAIEatGrass", TransformUtil
                                        .remapFieldName("net/minecraft/entity/ai/EntityAIEatGrass", "field_151501_c"),
                                "Lnet/minecraft/world/World;"));
                        nom.instructions.insert(insertAfter, new VarInsnNode(Opcodes.ALOAD, 0));

                        nom.instructions.insert(grassAfter,
                                new JumpInsnNode(Opcodes.IFEQ, ((JumpInsnNode) grassAfter).label));
                        nom.instructions.insert(grassAfter,
                                new MethodInsnNode(Opcodes.INVOKESTATIC, TransformUtil.HOOKS_COMMON, "checkWardGeneric",
                                        "(Lnet/minecraft/world/World;Lnet/minecraft/util/math/BlockPos;)Z", false));
                        nom.instructions.insert(grassAfter,
                                new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/minecraft/util/math/BlockPos",
                                        TransformUtil.remapMethodName("net/minecraft/util/math/BlockPos",
                                                "func_177977_b", Type.getType("Lnet/minecraft/util/math/BlockPos;")),
                                        "()Lnet/minecraft/util/math/BlockPos;", false));
                        nom.instructions.insert(grassAfter, new VarInsnNode(Opcodes.ALOAD, 1));
                        nom.instructions.insert(grassAfter, new FieldInsnNode(Opcodes.GETFIELD,
                                "net/minecraft/entity/ai/EntityAIEatGrass", TransformUtil
                                        .remapFieldName("net/minecraft/entity/ai/EntityAIEatGrass", "field_151501_c"),
                                "Lnet/minecraft/world/World;"));
            ...
            if (!found)
                throw new TransformerException(
                        "Could not locate required instructions, locations: " + tallGrass + ", " + normalGrass);
