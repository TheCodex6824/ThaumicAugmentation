...
public class TransformerInfusionLeftoverItems extends Transformer {
    ...
    public boolean transform(ClassNode classNode, String transformedName) {
        try {
            ...
            int offset = TransformUtil.findLastInstanceOfMethodCall(finish, finish.instructions.size(),
            ...
            if (offset != -1) {
                ...
                finish.instructions.insert(insertAfter, new MethodInsnNode(Opcodes.INVOKESTATIC,
                        TransformUtil.HOOKS_COMMON, "getLeftoverInfusionIngredientStack",
                        "(Lnet/minecraft/item/ItemStack;Ljava/lang/Object;)Lnet/minecraft/item/ItemStack;", false));
                finish.instructions.insert(insertAfter, new FieldInsnNode(Opcodes.GETFIELD,
                        "thaumcraft/common/tiles/crafting/TileInfusionMatrix", "recipeOutput", "Ljava/lang/Object;"));
