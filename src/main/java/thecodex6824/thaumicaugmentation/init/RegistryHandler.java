...
public final class RegistryHandler {
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        registry.register(setupItem(new ItemImpulseCannonConversion(), "impulse_cannon_augment"));
        registry.register(setupItem(new ItemImpulseCannonAugment(), "impulse_cannon_augment2"));
