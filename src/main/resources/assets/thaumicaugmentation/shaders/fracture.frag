...
// this is a modified version of Thaumcraft's ender.frag (no idea where they got it from) to remove the color modification
...
void main() {
    // background colour
    vec4 col = vec4(0.064,0.036,0.063,1);
